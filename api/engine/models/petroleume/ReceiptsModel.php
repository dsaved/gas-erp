...
class ReceiptsModel extends BaseModel
{
    ...
    public function receipt_omc()
    {
        ...
        return $this->receiptWithOmc(" WHERE ".self::$table.".`id`= $id AND ".self::$table.".`omc_id`= $omcid");
    }
    ...
    public function receiptWithOmc($condition="")
    {
        ...
        $this->paging->rawQuery("SELECT ".self::$table.".*, omc.name,omc.phone,omc.location,omc.region,omc.email,omc.district FROM ".self::$table." JOIN omc ON ".self::$table.".omc_id = omc.id Order By ".self::$table.".`id` DESC");
