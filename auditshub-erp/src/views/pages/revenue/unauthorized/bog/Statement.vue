  ...
  <div id="record-org-view">
    ...
    >
      ...
      <span>
        ...
        ><router-link
          :to="
            '/revenue/unauthorized/org/' + accountid + '/list/' + offset_account
          "
              ...
              >
                ...
                <div class="vx-col sm:w-1/3 w-full mb-2 mt-2">
                  ...
                  <ds-file-upload
                    ...
                    upload-url="/unauthorized/upload_file/"
        ...
        .then((response) => {
          ...
          if (response.data.success) {
            ...
            if (this.record.statement_id !== this.stmid) {
              this.$router.replace(
                `/revenue/unauthorized/org/${this.accountid}/list/${this.offset_account}/v/${this.pagination.page}/${this.record.statement_id}`
              );
            }
