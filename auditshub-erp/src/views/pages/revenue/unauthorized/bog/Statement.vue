  ...
  <div id="record-org-view">
    ...
    >
      ...
      <span>
        ...
        ><router-link
          :to="
            '/revenue/unauthorized/bog/' + accountid + '/list/' + offset_account
          "
        ...
        .then((response) => {
          ...
          if (response.data.success) {
            ...
            if (this.record.statement_id !== this.stmid) {
              this.$router.replace(
                `/revenue/unauthorized/bog/${this.accountid}/list/${this.offset_account}/v/${this.pagination.page}/${this.record.statement_id}`
              );
            }
