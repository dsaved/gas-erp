        ...
        <header class="header-table vs-table--header my-3">
          ...
          >
            <vs-button
              ...
              v-if="canAdd()"
              icon="icon-plus"
              v-on:click="linkto('/revenue/rates/add')"
              >Add Rate</vs-button
            >
            <vs-button
              class="mx-2"
            ...
            <table class="vs-table vs-table--tbody-table">
              ...
              <tbody>
                <tr
                  ...
                  :key="index"
                  v-on:click="linkto('/revenue/rates/' + record.id)"
                ...
                >
                  ...
                  <td>
                    <feather-icon
                      ...
                      v-if="canUpdate()"
                      @click.stop="
                        linkto('/revenue/rates/' + record.id)
                      "
                    />
                    <feather-icon
                      icon="TrashIcon"
			...
			this.post('/surcharge/', {
				...
				.then((response) => {
					...
					if (response.data.success == true) {
						this.message = ''
						this.records = response.data.surcharges
					} else {
						this.records = []
