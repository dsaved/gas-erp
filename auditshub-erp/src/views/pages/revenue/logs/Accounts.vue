              ...
              <table class="vs-table vs-table--tbody-table">
                <thead class="vs-table--thead">
                  <tr>
                    ...
                    <th scope="col" class="text-center">Number Of Transactions</th>
                ...
                <tbody>
                  <tr
                    ...
                    :key="index"
                    v-on:click="
                      linkto('/revenue/logs/' + record.account_id_from)
                    "
                  ...
                  >
                    <td scope="row" @click.stop="">
                      <vs-checkbox
                        ...
                        :vs-value="record.account_id_from"
                        >{{ number(index) }}</vs-checkbox
                      >
                    </td>
                    <td>
                      <b>{{ record.account_name_from | title }}</b> <br />
                      {{ record.account_number_from }}
                    </td>
