...
<template>
  <div id="bdc-org-view">
    ...
    >
      <span>DBC record with id: {{ bdcid }} not found. </span>
      <span>
        <span>Check </span
        ><router-link :to="{ name: 'bdc-org-list' }" class="text-inherit underline"
          >All OMCs</router-link
        >
      </span>
    </vs-alert>

    <div id="bdc-data" v-if="user_found">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col w-full flex" id="account-manage-buttons">
            <vs-button
              ...
              class="mx-1"
              v-if="canUpdate()"
              :to="{ name: 'bdc-org-edit', params: { bdcid: bdcid } }"
              >Edit</vs-button
            >
            <vs-button
              type="border"
