          ...
          <table class="vs-table vs-table--tbody-table">
            ...
            <tbody>
              <tr
                ...
                :key="index"
                v-on:click="linkto('/banks/' + record.id)"
              ...
              >
                ...
                <td>
                  <feather-icon
                    ...
                    v-if="canUpdate()"
                    @click.stop="linkto('/banks/' + record.id)"
                  />
                  <feather-icon
                    icon="TrashIcon"
...
export default {
  ...
  methods: {
    ...
    delete: function (ids) {
      this.showLoading("Deleting bank(s), hang on a bit...");
      this.post("/banks/delete", {
        id: ids,
      })
        .then((response) => {
          this.closeLoading();
          if (response.data.success == true) {
            Swal.fire("Deleted!", "The bank(s) has been deleted.", "success");
