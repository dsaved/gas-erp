<template>
  <vx-card title="Account Category">
    <p></p>
      ...
      <header class="header-table vs-table--header my-3">
        ...
        >
          <vs-button
            ...
            v-if="canAdd()"
            icon="icon-plus"
            v-on:click="linkto('/accounts/category/add')"
            >Add Account Category</vs-button
          >
          <vs-button
            class="mx-2"
            color="danger"
            ...
            >Delete Account Category</vs-button
          >
        </div>
        <div
          class="flex flex-wrap-reverse items-center data-list-btn-container"
          ...
          <table class="vs-table vs-table--tbody-table">
            ...
            <tbody>
              <tr
                ...
                :key="index"
                v-on:click="linkto('/accounts/category/' + record.id)"
              ...
              >
                ...
                <td>
                  <feather-icon
                    ...
                    v-if="canUpdate()"
                    @click.stop="linkto('/accounts/category/' + record.id)"
                  />
                  <feather-icon
                    icon="TrashIcon"
