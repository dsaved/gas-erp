<template>
  <div>
    <vx-card title="PETROLEUM INPUT ANALYTICS">
      <p></p>
      <div class="vs-component vs-con-table stripe vs-table-secondary">
        <div class="w-full flex mb-4">
          ...
          <div class="w-1/5 px-2">
            <span>IDF Condition</span>
            <ajax-select
              placeholder="Select Condition"
              :options="['All', 'Has IDF', 'No IDF']"
              :clearable="false"
              :dir="$vs.rtl ? 'rtl' : 'ltr'"
              :selected="idf_condition"
          ...
          <div class="w-1/5 px-2">
            ...
            <ajax-select
              placeholder="Select Condition"
              :options="['All', 'Declared', 'Not Declared']"
              :clearable="false"
              :dir="$vs.rtl ? 'rtl' : 'ltr'"
              :selected="declaration_condition"
              v-on:update:data="declaration_condition = $event"
            />
          </div>
          <div class="w-1/5 px-2">
            <span>Status</span>
            <ajax-select
              ...
              :options="['All', 'Cleared', 'Not Cleared']"
              :clearable="false"
              :dir="$vs.rtl ? 'rtl' : 'ltr'"
              :selected="status"
            ...
            <table class="vs-table vs-table--tbody-table">
              <thead class="vs-table--thead">
                <tr>
                  ...
                  <th scope="col">BDC</th>
                  <th scope="col">Total Manifest Vol.</th>
                  <th scope="col">Total Declaration Vol.</th>
                  <th scope="col">Vol. Difference</th>
                  <th scope="col" class="text-right">Total Amount</th>
                  <th scope="col" class="text-right">Total Amount Difference</th>
