            ...
            <table class="vs-table vs-table--tbody-table">
              <thead class="vs-table--thead">
                <tr>
                  ...
                  <th scope="col">Importer (BDC)</th>
                  <th scope="col">UCR No.</th>
                  <th scope="col">HS Code</th>
                  <th scope="col">Cleared Date</th>
                  <th scope="col">IDF App. No.</th>
                  <th scope="col">IDF Amount</th>
                </tr>
              </thead>
              <tbody>
                <tr
...
export default {
  ...
  data() {
    return {
      ...
      importDetails: "",
      importStatus: "",
      //declarations data list starts here
      pkey: "input-declaration-list",
      message: "",
      numbering: 0,
      currentPage: 1,
      result_per_page: 20,
  ...
  methods: {
      ...
      this.post("/declarations", {
        ...
        .then((response) => {
          ...
          if (response.data.success == true) {
            ...
            this.message = "";
            this.records = response.data.declarations;
          } else {
      ...
      this.post("/declarations/delete", {
        ...
        .then((response) => {
          ...
          if (response.data.success == true) {
            this.$vs.notify({
              title: "Error!!!",
              text: "The Declaration has been deleted.",
              sticky: true,
              border: "danger",
              color: "dark",
              duration: null,
    ...
    checkStatusForImport: function (id) {
      this.post("/declarations/import_status", {
        jobid: id,
      })
        .then((response) => {
