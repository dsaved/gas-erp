<template>
  <div class="cl">
            ...
            <table class="vs-table vs-table--tbody-table">
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    {{ record.preorder_date | dateyear(true) }}
                  </td>
                  <td>
                    {{ record.omc }}
                  </td>
    ...
    >
      ...
      <p>
        Please select the file containing the <b>Preorder</b> list you wish to
        import.
      </p>
      ...
      <p class="mt-4">
        <ds-file-upload
          upload-button-lable="Upload Preorder"
          type="relief"
          color="primary"
          max-size="5072"
          description="Allowed XLSX and XLX, Max size of 5MB"
          upload-url="/preorder/import/"
...
export default {
  ...
  methods: {
      ...
      this.post("/preorder", {
        ...
        .then((response) => {
          ...
          if (response.data.success == true) {
            ...
            this.message = "";
            this.records = response.data.preorders;
          } else {
    ...
    deleteWarn: function () {
      ...
      Swal.fire({
        title: "Are you sure?",
        html: `<p>you are about to remove all preorders from the system!</p><span class="text-warning">You won't be able to revert this! </span>`,
        icon: "warning",
        showCancelButton: true,
        confirmButtonColor: "#3085d6",
        cancelButtonColor: "#d33",
    ...
    delete: function () {
      this.showLoading("Deleting Preorder, hang on a bit...");
      this.post("/preorder/delete", {})
        .then((response) => {
          this.closeLoading();
          if (response.data.success == true) {
            this.$vs.notify({
              title: "Error!!!",
              text: "The Preorder has been deleted.",
              sticky: true,
              border: "danger",
              color: "dark",
              duration: null,
