<template>
  <div>
    <vx-card title="UNDECLARED PRODUCTS">
      <p></p>
...
export default {
  ...
  data() {
    return {
      ...
      pkey: "undeclaredproducts-model-list",
      message: "",
      numbering: 0,
      currentPage: 1,
      result_per_page: 20,
  ...
  methods: {
    ...
    getData() {
      this.showLoading("Getting reports...");
      this.post("/undecleredproducts", {
