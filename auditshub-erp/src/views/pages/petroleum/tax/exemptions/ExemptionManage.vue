<template>
  <div class="cl">
    <vx-card title="Create tax Exemption">
      <p>
        Creating an <b>exemption</b> for a particuler OMC will exclude that OMC
        from paying for that tax<br />
        ...
        <form :key="form_key">
          <div class="vx-row">
            <div class="vx-col sm:w-1/2 w-full mb-2">
              <ajax-select
                placeholder="Select nominated omc"
                :options="[]"
                url="/omc/options"
                :clearable="false"
                :dir="$vs.rtl ? 'rtl' : 'ltr'"
              ...
              <vs-input
                ...
                hidden
              />
              <span class="text-danger text-sm" v-show="errors.has('omc')">{{
                errors.first("omc")
              }}</span>
            </div>
            ...
            <div class="vx-col sm:w-1/3 w-full mb-2">
              <vs-input
                ...
                label-placeholder="Exempted Company"
                name="company"
                v-model="company"
                class="mt-5 w-full"
              />
            ...
            <div class="vx-col sm:w-1/3 w-full mb-2">
              <vs-input
                v-validate="{ required: true }"
                label-placeholder="Exempted Conpany TIN"
                name="TIN"
                v-model="company_tin"
                class="mt-5 w-full"
              />
            ...
            <div class="vx-col sm:w-1/3 w-full mb-2">
              ...
              <span
                class="text-danger text-sm"
                v-show="errors.has('litters')"
                >{{ errors.first("litters") }}</span
              >
            </div>
      ...
      this.post("/taxexemption/get/", {
        ...
        .then((response) => {
          ...
          if (response.data.success == true) {
            ...
            this.company_tin = result.company_tin;
          } else {
            this.$vs.notify({
              title: "Error!!!",
