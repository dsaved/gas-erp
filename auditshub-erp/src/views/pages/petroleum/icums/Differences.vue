<template>
  <div>
    <vx-card title="RECONCILIATION BTW WAYBILL & ICUMS DECLARATIONS">
      <p></p>
            ...
            <table class="vs-table vs-table--tbody-table">
              <thead class="vs-table--thead">
                <tr>
                  ...
                  <th scope="col">OMC</th>
                  <th scope="col">ICUMS DCL. Amount</th>
                  <th scope="col" class="text-right">Waybill EXP. DCL. Amount</th>
  ...
  methods: {
    ...
    async exportWarn() {
      const { value: filename } = await Swal.fire({
        ...
        inputValue: `${this.status}-icums-defferences-${new Date().getTime()}`,
