<template>
  <div class="cl">
    ...
    >
      ...
      <p>
        Please select the file containing the <b>Waybills</b> list you wish to
        import.
      </p>
...
export default {
  ...
  data() {
    return {
      ...
      importDetails: "",
      importStatus: "",
      //waybills data list starts here
      pkey: "waybill-list",
      message: "",
      numbering: 0,
      currentPage: 1,
  ...
  methods: {
      ...
      this.post("/waybills", {
        ...
        .then((response) => {
          ...
          if (response.data.success == true) {
            ...
            this.message = "";
            this.records = response.data.waybills;
          } else {
      ...
      this.post("/waybills/delete", {})
        .then((response) => {
          ...
          if (response.data.success == true) {
            this.$vs.notify({
              title: "Error!!!",
              text: "The Waybills has been deleted.",
              sticky: true,
              border: "danger",
              color: "dark",
              duration: null,
    ...
    checkStatusForImport: function (id) {
      this.post("/waybills/import_status", {
        jobid: id,
      })
        .then((response) => {
