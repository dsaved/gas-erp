        ...
        <header class="header-table vs-table--header my-3">
          ...
          >
            <vs-button
              ...
              v-if="canAdd()"
              icon="icon-plus"
              v-on:click="linkto('/petroleume/tax-schedule/add')"
              >Add Tax Schedule</vs-button
            >
            <vs-button
              class="mx-2"
              color="danger"
            ...
            <table class="vs-table vs-table--tbody-table">
              ...
              <tbody>
                <tr
                  ...
                  :key="index"
                  v-on:click="linkto('/petroleume/tax-schedule/' + record.id)"
                ...
                >
                  ...
                  <td>
                    <feather-icon
                      ...
                      v-if="canUpdate()"
                      @click.stop="
                        linkto('/petroleume/tax-schedule/' + record.id)
                      "
                    />
                    <feather-icon
                      icon="TrashIcon"
      ...
      this.post("/taxschedule/", {
        ...
        .then((response) => {
          ...
          if (response.data.success == true) {
            this.message = "";
            this.records = response.data.schedules;
          } else {
            this.records =[]
