      ...
      <header class="header-table vs-table--header my-3">
        ...
        >
          <vs-button
            ...
            v-if="canAdd()"
            icon="icon-plus"
            v-on:click="linkto('/petroleume/tax-product/add')"
            >Add Tax Product</vs-button
          >
          <vs-button
            class="mx-2"
            color="danger"
          ...
          <table class="vs-table vs-table--tbody-table">
            ...
            <tbody>
              <tr
                ...
                :key="index"
                v-on:click="linkto('/petroleume/tax-product/' + record.id)"
              ...
              >
                ...
                <td>
                  <feather-icon
                    ...
                    v-if="canUpdate()"
                    @click.stop="linkto('/petroleume/tax-product/' + record.id)"
                  />
                  <feather-icon
                    icon="TrashIcon"
      ...
      this.post("/taxproducts/", {
        ...
        .then((response) => {
          ...
          if (response.data.success == true) {
            this.message = "";
            this.records = response.data.products;
          } else {
            this.records =[]
