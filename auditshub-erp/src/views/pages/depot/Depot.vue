      ...
      <header class="header-table vs-table--header my-3">
        ...
        >
          <vs-button
            ...
            v-if="canAdd()"
            icon="icon-plus"
            v-on:click="linkto('/accounts/depot/add')"
            >Add Depot</vs-button
          >
          <vs-button
            class="mx-2"
          ...
          <table class="vs-table vs-table--tbody-table">
            ...
            <tbody>
              <tr
                ...
                :key="index"
                v-on:click="linkto('/accounts/depot/' + record.id+'/view')"
              ...
              >
                ...
                <td>
                  <feather-icon
                    ...
                    v-if="canUpdate()"
                    @click.stop="linkto('/accounts/depot/' + record.id)"
                  />
                  <feather-icon
                    icon="TrashIcon"
