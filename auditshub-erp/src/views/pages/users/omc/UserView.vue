...
<template>
  <div id="page-user-view">
    ...
    >
      ...
      <span>
        <span>Check </span
        ><router-link :to="{ name: 'OMCs' }" class="text-inherit underline"
          >All OMC Users</router-link
        >
      </span>
    </vs-alert>
        ...
        <div class="vx-row">
          ...
          <div class="vx-col flex-1" id="account-info-col-2">
            <table>
              ...
              <tr>
                <td class="font-semibold">OMC</td>
                <td>{{ user.organization.label }}</td>
              </tr>
            </table>
          </div>
          <!-- /Information - Col 2 -->
          <div class="vx-col w-full flex" id="account-manage-buttons">
            <vs-button
              ...
              class="mr-4"
              v-if="canUpdate()"
              :to="{ name: 'Update OMC User', params: { userid: userid } }"
              >Edit</vs-button
            >
            <vs-button
              type="border"
