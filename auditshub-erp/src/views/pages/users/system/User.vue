      ...
      <header class="header-table vs-table--header my-3">
        ...
        >
          <vs-button
            ...
            v-if="canAdd()"
            icon="icon-plus"
            v-on:click="linkto('/accounts/users/add')"
            >Add User</vs-button
          >
          <vs-button
            class="mx-2"
          ...
          <table class="vs-table vs-table--tbody-table">
            ...
            <tbody>
              <tr
                ...
                :key="index"
                v-on:click="linkto('/accounts/users/' + record.id + '/view')"
              ...
              >
                ...
                <td>{{ record.email }}</td>
                <td>
                  <vs-chip v-if="record.role" transparent :color="`rgb(${getRandomInt(6,120)},${getRandomInt(8,120)},${getRandomInt(0,120)})`">
                    <vs-avatar :text="acronum(record.role)" />
                    {{ record.role | title }}
                  </vs-chip>
                </td>
                <td>
                  <feather-icon
                    ...
                    v-if="canUpdate()"
                    @click.stop="linkto('/accounts/users/' + record.id)"
                  />
                  <feather-icon
                    icon="TrashIcon"
