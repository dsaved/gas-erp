          ...
          <header class="header-table vs-table--header my-3">
            ...
            >
              <vs-button
                ...
                icon-pack="feather"
                v-if="canAdd()"
                @click="linkto('/accounts/bank-account/add')"
                icon="icon-plus"
                class="mx-1"
              ...
              <table class="vs-table vs-table--tbody-table">
                ...
                <tbody>
                  <tr
                    ...
                    :key="index"
                    v-on:click="linkto('/accounts/bank-account/' + record.id+'/view')"
                  ...
                  >
                    ...
                    <td>
                      <feather-icon
                        ...
                        v-if="canUpdate()"
                        @click.stop="
                          linkto('/accounts/bank-account/' + record.id)
                        "
                      />
                      <feather-icon
                        icon="TrashIcon"
