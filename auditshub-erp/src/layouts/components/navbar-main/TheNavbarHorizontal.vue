...
<div class="relative">
  <div class="vx-navbar-wrapper navbar-full p-0">
    <vs-navbar class="navbar-custom navbar-skelton" :class="navbarClasses"  :style="navbarStyle" :color="navbarColor">
      ...
      <router-link tag="div" to="/" class="cursor-pointer mx-auto flex items-center">
        <span class="vx-logo-text text-primary">SML a</span>
      </router-link>
...
<script>
import Bookmarks            from '../sub-components/Bookmarks.vue'
import SearchBar            from '../sub-components/SearchBar.vue'
import NotificationDropDown from '../sub-components/NotificationDropDown.vue'
import ProfileDropDown      from '../sub-components/ProfileDropDown.vue'
