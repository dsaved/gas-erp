              ...
              <div v-if="$route.meta.breadcrumb || $route.meta.pageTitle" class="router-header flex flex-wrap items-center mb-6">
                ...
                <vs-dropdown vs-trigger-click class="ml-auto md:block hidden cursor-pointer">
                  ...
                  <vs-dropdown-menu class="w-32">
                    <vs-dropdown-item>
                      <div @click="$router.push('/revenue/accounts/profile').catch(() => {})" class="flex items-center">
...
import navMenuItems        from '@/layouts/components/menu-items/navRevenueMenuItems.js'
import TheNavbarHorizontal from '@/layouts/components/navbar-revenue/TheNavbarHorizontal.vue'
import TheNavbarVertical   from '@/layouts/components/navbar-revenue/TheNavbarVertical.vue'
