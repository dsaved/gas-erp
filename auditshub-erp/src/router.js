...
const router = new Router({
	...
	routes: [

		{
			...
			children: [
				...
				// =============================================================================
				{
					path: '/accounts/bdc',
					name: 'BDCs',
					component: () => import ('./views/pages/users/bdc/BDCs.vue'),
					meta: {
				...
				},
				{
					...
					name: 'Add BDC User',
					component: () => import ('./views/pages/users/bdc/UserManage.vue'),
					meta: {
						identity: 'BDC users', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				},
				{
					...
					component: () => import ('./views/pages/users/bdc/UserView.vue'),
					meta: {
						identity: 'BDC users', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
...

				{
					...
					name: 'omc-org-list',
					component: () => import ('./views/pages/omc-organization/OMC.vue'),
					meta: {
				...
				},
				{
					...
					name: 'omc-org-add',
					component: () => import ('./views/pages/omc-organization/OMCManage.vue'),
					meta: {
						identity: 'OMC Organization Manage', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/' },
				...
				},
				{
					...
					name: 'omc-org-view',
					component: () => import ('./views/pages/omc-organization/OMCView.vue'),
					meta: {
						identity: 'OMC Organization Manage', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/' },
				...
				// =============================================================================
				{
					path: '/accounts/omc',
					name: 'OMCs',
					component: () => import ('./views/pages/users/omc/OMCs.vue'),
					meta: {
				...
				},
				{
					...
					name: 'Add OMC User',
					component: () => import ('./views/pages/users/omc/UserManage.vue'),
					meta: {
						identity: 'OMC users', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				},
				{
					...
					component: () => import ('./views/pages/users/omc/UserView.vue'),
					meta: {
						identity: 'OMC users', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				// =============================================================================
				{
					path: '/accounts/users',
					name: 'Users',
					component: () => import ('./views/pages/users/system/User.vue'),
					meta: {
				...
				},
				{
					...
					name: 'Add User',
					component: () => import ('./views/pages/users/system/UserManage.vue'),
					meta: {
						identity: 'System Users', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				},
				{
					...
					name: 'User Details',
					component: () => import ('./views/pages/users/system/UserView.vue'),
					meta: {
						identity: 'System Users', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				// =============================================================================
				{
					path: '/accounts/roles',
					name: 'User Role',
					component: () => import ('./views/pages/users/UserRole.vue'),
					meta: {
				...
				},
				{
					...
					name: 'User Role Add',
					component: () => import ('./views/pages/users/UserRoleManage.vue'),
					meta: {
						identity: 'System User Role', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
...

				{
					path: '/banks',
					name: 'banks',
					component: () => import ('./views/pages/banks/Banks.vue'),
					meta: {
						identity: 'Banks',
						breadcrumb: [
							{ title: 'Home' },
					...
					path: '/banks/add',
					name: 'ass-bank',
					component: () => import ('./views/pages/banks/BankManage.vue'),
					meta: {
						identity: 'Banks',
						breadcrumb: [
							{ title: 'Home' },
...

				{
					...
					component: () => import ('./views/pages/banks/AccountCategories.vue'),
					meta: {
					...
					name: 'add-category',
					component: () => import ('./views/pages/banks/AccountCategoryManage.vue'),
					meta: {
						identity: 'Account Categories',
						breadcrumb: [
							{ title: 'Home' },
...

				{
					...
					name: 'bank-account',
					component: () => import ('./views/pages/bank-account/Accounts.vue'),
					meta: {
					...
					component: () => import ('./views/pages/bank-account/AccountManage.vue'),
					meta: {
						identity: 'Bank Account',
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/bank-account/AccountView.vue'),
					meta: {
						identity: 'Bank Account',
						breadcrumb: [
							{ title: 'Home' },
...

				{
					path: '/organizations',
					name: 'organizations',
					component: () => import ('./views/pages/organizations/Organizations.vue'),
					meta: {
					...
					component: () => import ('./views/pages/organizations/OrganizationManage.vue'),
					meta: {
						identity: 'Organizations',
						breadcrumb: [
							{ title: 'Home' },
		...
		},
		{
			...
			// =============================================================================
			path: '/petroleum',
			component: () => import ('./layouts/main/Petroleum.vue'),
			children: [
				// =============================================================================
				// Theme Routes
				// =============================================================================
				{
					path: '/petroleum',
					name: 'petroleum home',
					component: () => import ('./views/pages/petroleum/Home.vue'),
					meta: {
				...
				// =============================================================================
				{
					...
					name: 'Tax List',
					component: () => import ('./views/pages/petroleum/tax/tax-type/Tax.vue'),
					meta: {
				...
				},
				{
					...
					name: 'add-tax-type',
					component: () => import ('./views/pages/petroleum/tax/tax-type/TaxManage.vue'),
					meta: {
						identity: 'Tax Type', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				},
				{
					...
					component: () => import ('./views/pages/petroleum/tax/products/Products.vue'),
					meta: {
				...
				},
				{
					...
					component: () => import ('./views/pages/petroleum/tax/products/ProductManage.vue'),
					meta: {
						identity: 'Tax Products', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				},
				{
					...
					name: 'Tax Schadules',
					component: () => import ('./views/pages/petroleum/tax/tax-schedule/TaxSchadules.vue'),
					meta: {
				...
				},
				{
					...
					component: () => import ('./views/pages/petroleum/tax/tax-schedule/TaxScheduleManage.vue'),
					meta: {
						identity: 'Tax Schedule', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				},
				{
					...
					name: 'Exemptions',
					component: () => import ('./views/pages/petroleum/tax/exemptions/Exemptions.vue'),
					meta: {
				...
				},
				{
					...
					name: 'add-exemptions',
					component: () => import ('./views/pages/petroleum/tax/exemptions/ExemptionManage.vue'),
					meta: {
						identity: 'Exemptions', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				},
				{
					...
					component: () => import ('./views/pages/revenue/system/Monitor.vue'),
					meta: {
					...
					component: () => import ('./views/pages/revenue/system/Downloads.vue'),
					meta: {
						identity: 'neutral', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
...

				{
					path: '/petroleum/omc',
					name: 'omc-list',
					component: () => import ('./views/pages/petroleum/omc/OMC.vue'),
					meta: {
				...
				},
				{
					...
					name: 'omc-view',
					component: () => import ('./views/pages/petroleum/omc/OMCView.vue'),
					meta: {
				...
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/petroleum/omc/fallout/OMC.vue'),
					meta: {
				...
				},
				{
					...
					component: () => import ('./views/pages/petroleum/omc/fallout/OMCView.vue'),
					meta: {
						identity: 'Fall Out Receipts',
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				},
				{
					...
					component: () => import ('./views/pages/petroleum/omc/fallout/OMCReceiptView.vue'),
					meta: {
						identity: 'OMCs', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/petroleum/omc/logs/Accounts.vue'),
					meta: {
					...
					component: () => import ('./views/pages/petroleum/omc/logs/Transactions.vue'),
					meta: {
						identity: 'Reconcilation Log',
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/petroleum/omc/OMCComputeLiftings.vue'),
					meta: {
						identity: 'OMCs', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				},
				{
					...
					name: 'omc-reconcile',
					component: () => import ('./views/pages/petroleum/omc/OMCReconcile.vue'),
					meta: {
						identity: 'OMCs', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				},
				{
					...
					component: () => import ('./views/pages/petroleum/omc/OMCReceiptView.vue'),
					meta: {
						identity: 'OMCs', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home', url: '/petroleum' },
				...
				// =============================================================================
				{
					...
					name: 'sml-npa',
					component: () => import ('./views/pages/petroleum/reconcile/SmlNpa.vue')
				},
				{
					path: '/petroleum/rcn/npa-icoms',
					name: 'npa-icoms',
					component: () => import ('./views/pages/petroleum/reconcile/NpaIcoms.vue')
				},
				{
					path: '/petroleum/rcn/npa-npa',
					name: 'npa-npa',
					component: () => import ('./views/pages/petroleum/reconcile/NpaNpa.vue')
				},
				// =============================================================================
				// NPA MENU START HERE
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/petroleum/npa/ReconcilationReport.vue')
				},
				{
					path: '/petroleum/npa/daily-liftings',
					name: 'npa daily-liftings',
					component: () => import ('./views/pages/petroleum/npa/DailyLiftings.vue')
				},
				// =============================================================================
				...
				// =============================================================================
				{
					...
					name: 'declearations',
					component: () => import ('./views/pages/petroleum/icoms/Declearations.vue')
				},
				{
					path: '/petroleum/icoms/payments',
					name: 'payments',
					component: () => import ('./views/pages/petroleum/icoms/Payments.vue')
				},
				{
					path: '/petroleum/icoms/differences',
					name: 'differences',
					component: () => import ('./views/pages/petroleum/icoms/Differences.vue')
				},
				// =============================================================================
				// SML MENU START HERE
				// =============================================================================
				...
				// =============================================================================
				{
					...
					name: 'compute',
					component: () => import ('./views/pages/petroleum/Compute.vue'),
					meta: {
		...
		// =============================================================================
		{
			...
			// =============================================================================
			path: '/revenue',
			component: () => import ('./layouts/main/Revenue.vue'),
			children: [
				// =============================================================================
				// Theme Routes
				// =============================================================================
				{
					path: '/revenue',
					name: 'revenue-home',
					component: () => import ('./views/pages/revenue/Home.vue'),
					meta: {
						identity: 'Home', //this should match then page in navMainMenuItems.js
						breadcrumb: [{ title: 'Home', active: true }],
						homeurl: '/revenue',
				...
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/revenue/responses/Accounts.vue'),
					meta: {
					...
					component: () => import ('./views/pages/revenue/responses/Transactions.vue'),
					meta: {
						identity: 'Audit Responses', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/responses/Statement.vue'),
					meta: {
						identity: 'Audit Responses', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
...

				{
					...
					name: 'rbank-account',
					component: () => import ('./views/pages/revenue/bank-account/Accounts.vue'),
					meta: {
						identity: 'Bank Account',
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/bank-account/AccountView.vue'),
					meta: {
						identity: 'Bank Account',
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/bank-account/AccountTransactionView.vue'),
					meta: {
						identity: 'Bank Account',
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/bank-account/AccountReconcile.vue'),
					meta: {
						identity: 'Bank Account',
						breadcrumb: [
							{ title: 'Home' },
				...
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/revenue/unauthorized/bog/Accounts.vue'),
					meta: {
					...
					component: () => import ('./views/pages/revenue/unauthorized/bog/Recipients.vue'),
					meta: {
						identity: 'Unauthorized Bank of Ghana', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/unauthorized/bog/Transactions.vue'),
					meta: {
						identity: 'Unauthorized Bank of Ghana', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/unauthorized/bog/Statement.vue'),
					meta: {
						identity: 'Unauthorized Bank of Ghana', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/revenue/unauthorized/org/Accounts.vue'),
					meta: {
						identity: 'Unauthorized Bank of Ghana', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/unauthorized/org/Recipients.vue'),
					meta: {
					...
					component: () => import ('./views/pages/revenue/unauthorized/org/Transactions.vue'),
					meta: {
						identity: 'Unauthorized Other Banks', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/unauthorized/org/Statement.vue'),
					meta: {
						identity: 'Unauthorized Other Banks', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				// =============================================================================
				{
					...
					component: () => import ('./views/pages/revenue/unauthorized/hidden/Accounts.vue'),
					meta: {
					...
					component: () => import ('./views/pages/revenue/unauthorized/hidden/Recipients.vue'),
					meta: {
						identity: 'Unauthorized Hidden Transactions', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/unauthorized/hidden/Transactions.vue'),
					meta: {
						identity: 'Unauthorized Hidden Transactions', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
					...
					component: () => import ('./views/pages/revenue/unauthorized/hidden/Statement.vue'),
					meta: {
						identity: 'Unauthorized Hidden Transactions', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
				...
				// =============================================================================
				{
					path: '/revenue/logs',
					name: 'audits-logs',
					component: () => import ('./views/pages/revenue/logs/Accounts.vue'),
					meta: {
					...
					component: () => import ('./views/pages/revenue/logs/Transactions.vue'),
					meta: {
						identity: 'Audit Logs', //this should match then page in navMainMenuItems.js
						breadcrumb: [
							{ title: 'Home' },
