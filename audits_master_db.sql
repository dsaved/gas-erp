...
(5, 'mark', 'Oluwaseun Gbadero', 'mark@gmail.com', '0909646441', '', 2, 'Chief', '387728HFY', 'Barrier', 'Grater-Accra', 'Weija', 'omc', 'omc', 0, '/petroleume', '==QYpHQjdzpaazYnGMUfInVO', 'ab1416433452b8b9d3054f1b5871bc9f', '2020-11-06 12:50:00'),
(6, 'mary', 'Mary Johnson', 'mary@gmail.com', '0243848378', '', 0, 'commander', '3232G', 'Accra', 'Grater-Accra', 'dsaved8291@gmail.com', 'bdc', 'bdc', 0, '/petroleume/icoms/declearations', '==QcTAoTeXDdM9SJLgu566QR', 'be5dd3dc561c4e5e78ca18e0ccf530d0', '2020-11-06 13:33:35'),
...
(1, 1, 'Home,Revenue,Regimes,Petroleume,Accounts,BDC users,OMC users,System Users,System User Role,Petroleume Home,Tax,Tax Type,Tax Products,Tax Schedule,Exemptions,Compute Tax Schedule,OMCs,Reconcile,SML - NPA Reconcilations,NPA - ICOMS Reconcilations,NPA - NPA Reconcilations,NPA,NPA Reconcilation Reports,NPA Daily Liftings,ICOMS (CEPS),ICOMS Declearations,ICOMS Payments,ICOMS Differences,SML,SML Daily Liftings,Banks,Accounts (Bank),Organizations,Bank Accounts,Bank Account,Account Categories,Audit Logs,Audit Responses,Revenue Bank Accounts,Unauthorized,Unauthorized Bank of Ghana,Unauthorized Other Banks,Unauthorized Hidden Transactions,Accounts,OMC Organization Manage,Assets,Confirmed Assets,Disposed Assets,New Assets,Transfered Assets,Unknown Assets,Projects,GOG COA,Institutes,Funding,Organization,Location,Natural Accounts,Assets Validation,Assets Validations List,Assets Validations Completed,Reports'),
(4, 4, 'Revenue,Regimes,Petroleume,Accounts,BDC users,OMC users,System Users,System User Role,Home,Petroleume Home,Tasks,Set Up Task Type,Task Schedule,Exemptions,Compute Task Schedule,Reconcile,SML - NPA Reconcilations,NPA - ICOMS Reconcilations,NPA - NPA Reconcilations,NPA,NPA Reconcilation Reports,NPA Daily Liftings,ICOMS (CEPS),ICOMS Declearations,ICOMS Payments,ICOMS Differences,SML,SML Daily Liftings'),
(5, 5, ''),
(6, 6, 'ICOMS (CEPS),ICOMS Declearations,ICOMS Payments,ICOMS Differences'),
(7, 7, ''),
(8, 8, 'Home,Revenue,Regimes,Petroleume,Accounts,BDC users,OMC users,System Users,System User Role,Banks,Bank Accounts,Bank Account,Account Categories,Organizations,Compute Tax Schedule,Tax,Tax Type,Tax Products,Tax Schedule,Exemptions,Petroleume Home,OMCs,Reconcile,SML - NPA Reconcilations,NPA - ICOMS Reconcilations,NPA - NPA Reconcilations,NPA,NPA Reconcilation Reports,NPA Daily Liftings,ICOMS (CEPS),ICOMS Declearations,ICOMS Payments,ICOMS Differences,SML,SML Daily Liftings');
